...
const repoName = "https://github.com/rikkqa43/Plugins-";
...
SEEDR_MAIL: '',  
SEEDR_PASSWORD: '',    
OWNER_NUMBER: '94778500326',
LOGO: `https://i.ibb.co/0VM6G6jh/jpg.jpg` 
}
...
return await githubClearAndWriteFile("settings", "settings.json",JSON.stringify(get))
} else if (setting == "SEEDR_MAIL") {
get.SEEDR_MAIL = data
config.SEEDR_MAIL = data
return await githubClearAndWriteFile("settings", "settings.json",JSON.stringify(get))
} else if (setting == "SEEDR_PASSWORD") {
get.SEEDR_PASSWORD = data
config.SEEDR_PASSWORD = data
return await githubClearAndWriteFile("settings", "settings.json",JSON.stringify(get))
} 
...
return get.SEEDR_PASSWORD
} else if (setting == "SEEDR_MAIL") {
return get.SEEDR_MAIL
} 
...
config.JID = get.JID
config.SEEDR_MAIL = get.SEEDR_MAIL
...
SEEDR_MAIL: '',  
SEEDR_PASSWORD: '',   
OWNER_NUMBER: '94722617699',
LOGO: `https://files.catbox.moe/jorjkf.jpg` 
}
...
config.JID = '©MOVIE-VISPER MD'
config.SEEDR_MAIL = ''
config.SEEDR_PASSWORD = ''
config.OWNER_NUMBER = '94722617699'
config.ALIVE =`default`
config.PREFIX = '.'
config.LOGO = `https://files.catbox.moe/jorjkf.jpg` 
